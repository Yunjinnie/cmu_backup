...
def audio_main(*args):
    ...
    #             # Filtering
    #             # Prompt: QA
    #             prompt_for_answer = f"Your name is 'Petson' and you are a moving robot that helps people. Act as a 'Petson'. Answer to the given text within only one sentence: {s[0]}?"
    ...
    #             print(f"\nGenerated answer: {result_sanswer}\n")
    #             # if TTS_ON:
