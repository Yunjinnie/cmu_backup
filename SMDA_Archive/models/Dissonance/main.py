...
def main(args):
    ...
    ''' Build Model '''
    # Call network model
    model = Dissonance(visual_shape=config["model"]["visual_shape"], audio_shape=config["model"]["audio_shape"], num_classes=config["model"]["num_classes"])
